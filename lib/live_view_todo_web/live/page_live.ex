defmodule LiveViewTodoWeb.PageLive do
  ...
  # websocket topic defined as a module attribute, for subcribe/broadcast
  @topic "live"
  ...
  def handle_event("create", %{"text" => text}, socket) do
    ...
    # Will send the "update" event with the socket.assigns data to all the other clients on listening to the @topic.
  ...
  # these are the functions that handle events in "page_live.html.heex"
  def checked?(item) do
